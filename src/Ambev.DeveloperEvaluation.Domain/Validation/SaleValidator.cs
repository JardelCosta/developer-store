...
public class SaleValidator : AbstractValidator<Sale>
{
    public SaleValidator()
    {
        ...
        RuleFor(x => x.Customer)
            ...
            .ChildRules(customer =>
            {
                customer.RuleFor(c => c.ExternalId).NotEmpty().WithMessage("Customer ID is required.");
        ...
        RuleFor(x => x.Branch)
            ...
            .ChildRules(branch =>
            {
                branch.RuleFor(b => b.ExternalId).NotEmpty().WithMessage("Branch ID is required.");
        ...
        RuleFor(x => x.Items)
            ...
            .ForEach(item => item.ChildRules(i =>
            {
                ...
                i.RuleFor(it => it.Product.ExternalId).NotEmpty().WithMessage("Product ID is required.");
